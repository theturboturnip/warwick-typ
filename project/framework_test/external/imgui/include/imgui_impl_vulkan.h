...
// Modified (by Samuel Stark/TheTurboTurnip) to add a function for generating a DescriptorSet to use as ImTextureID, based on a Vulkan ImageView
...
IMGUI_IMPL_API VkDescriptorSet ImGui_ImplVulkan_MakeDescriptorSet(VkImageView imageView);
